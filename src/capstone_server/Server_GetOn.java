...
public class Server_GetOn {
	public static void main(String[] args) throws MqttException {
		MqttClient client = new MqttClient("tcp://192.168.0.28:1883", MqttClient.generateClientId());
			...
			public void messageArrived(String arg0, MqttMessage arg1) throws Exception {
				...
				while (waitArrived) {
					...
					NodeList stationSeqList = (NodeList) xpath.evaluate("//busLocationList/stationSeq", document,
							XPathConstants.NODESET);
					System.out.printf("%d %d -- ",plateNoList.getLength(),stationSeqList.getLength());
